...
By default, Shiny uses [Bootstrap
3](https://getbootstrap.com/docs/3.4/) for layouts and styling.
`inshiny` requires [Bootstrap
...
simple demo of a Shiny UI that uses all the widgets provided by
`inshiny`:
...
![](images/vignette_1.jpg){width="480"}
...
This version takes up more space:

![](images/vignette_2.jpg){width="480"}
