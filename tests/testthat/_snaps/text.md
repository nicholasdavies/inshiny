# text is stable
    ...
    Output
      <span class="inshiny-text-container">
        <span id="text_id" class="inshiny-nofocus inshiny-text-form" contenteditable tabindex="0" role="textbox" aria-placeholder="Enter some text" aria-label="Text input" style="max-width:10em">Hello.</span>
